...
from cmbfscnn_local.dataset import TestCMBMapDataset
from cmbml.torch.pytorch_model_handler import PyTorchModel  # Import for typing hint
from .pytorch_model_base_executor import BaseCMBFSCNNModelExecutor
...
class PredictionExecutor(BaseCMBFSCNNModelExecutor):
    def __init__(self, cfg: DictConfig) -> None:
        ...
        model_precision = cfg.model.model_precision
